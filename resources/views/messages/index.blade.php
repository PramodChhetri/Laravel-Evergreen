...
<h2 class="font-bold text-4xl text-black-700">Messages</h2> 
        ...
        <tbody>
            ...
            <tr>
              ...
              <td>{{$msg->created_at->diffForHumans()}}</td>
                <td>
                    <a onclick="showDelete('{{$msg->id}}')" class="bg-red-600 text-white px-2 py-1 rounded shadow hover:shadow-red-400 cursor-pointer">Delete</a>
                </td>
            </tr>
            @endforeach
