...
<h2 class="font-bold text-4xl text-black-700">Permissions</h2> 
<hr class="h-1 bg-red-500">

    <div class="my-4 text-right px-10">
        <a href="{{ route('permissions.create')}}" class="bg-amber-400 text-black px-4 py-2 rounded-lg shadow-md hover:shadow-amber-300">Add Permission</a>
    </div>
    ...
    <table id="mytable" class="display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('permissions.edit',$permission->id)}}" class="bg-blue-600 text-white px-2 py-1 rounded shadow hover:shadow-blue-400">Edit</a>

                    <a onclick="showDelete('{{$permission->id}}')" class="bg-red-600 text-white px-2 py-1 rounded shadow hover:shadow-red-400 cursor-pointer">Delete</a>
                </td>
            </tr>
            @endforeach
